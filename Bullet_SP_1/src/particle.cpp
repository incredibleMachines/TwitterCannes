...
void Particle::setup(ofxBulletWorldRigid* world, keyframe startPos, keyframe pixelPos, ofImage image, float imageWidth, float imageHeight, float myIndex) {
	...
	box->create(geometry->world, ofVec3f(startPos.pos.x, startPos.pos.y, startPos.pos.z), .05, .5, .5, .5);
	box->add();
