...
void Alphabet::setup(){
    int offsetUp[]={40, 41, 47, 59, 121, 159, 192, 193, 194, 195, 196, 197, 198, 199, 200, 201, 202, 203, 204, 205, 206, 207, 209, 210, 211, 212, 213, 214, 217, 218, 219, 220, 221, 229, 230, 231, 232, 233, 234, 235, 236, 237, 238, 239, 240, 241, 242, 243, 244, 245, 246, 249, 250, 251, 252, 253};
    int offsetDown[]={34, 39, 43, 44, 45, 95, 61, 97, 99, 101, 109, 110, 111, 114, 115, 117, 118, 120, 121, 122, 127,129, 215, 141, 143, 144,157,183};
    int doubleOffset[]={46, 133};
    maxY=0;
    int letter=0;
    for(int i=0;i<256;i++){
        ...
        if(i>32){
            ...
            for(int j=0; j<sizeof(doubleOffset);j++){
                if (doubleOffset[j]==i) newLetter->offset=-1.5;
            }
            newModel.clear();
        }
